...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SpecSkill',
            fields=[
                ('specSkills_id', models.AutoField(db_column='specskills', primary_key=True, serialize=False)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(blank=True, choices=[('PENDING', 'Pending'), ('ACTIVE', 'Active'), ('COMPLETED', 'Completed'), ('REJECTED', 'Rejected')], db_column='status', max_length=15, null=True)),
                ...
                ('specSkills', models.ForeignKey(blank=True, db_column='specskills', null=True, on_delete=django.db.models.deletion.RESTRICT, to='accounts.specskill')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('specskills_id', models.ForeignKey(blank=True, db_column='specskills_id', null=True, on_delete=django.db.models.deletion.RESTRICT, to='accounts.specskill')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('specSkills', models.ForeignKey(db_column='specskills', on_delete=django.db.models.deletion.RESTRICT, to='accounts.specskill')),
                ('user', models.ForeignKey(db_column='user_id', on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
            options={
